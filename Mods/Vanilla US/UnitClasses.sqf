...
// CSAT weapons
a3e_arr_AmmoDepotBasicWeapons pushback ["hgun_P07_F", 50, 4, 8, ["16Rnd_9x21_Mag", "16Rnd_9x21_red_Mag", "16Rnd_9x21_green_Mag", "16Rnd_9x21_yellow_Mag"], 6];
...
a3e_arr_AmmoDepotBasicWeapons pushback ["arifle_MX_GL_F", 75, 2, 4, ["30Rnd_65x39_caseless_mag", "30Rnd_65x39_caseless_mag_Tracer", "1Rnd_HE_Grenade_shell"], 6];
...
// non-CSAT weapons
a3e_arr_AmmoDepotBasicWeapons pushback ["hgun_PDW2000_F", 50, 4, 8, ["16Rnd_9x21_Mag", "30Rnd_9x21_Mag"], 6];
...
// CSAT weapons
a3e_arr_AmmoDepotSpecialWeapons pushback ["arifle_MXM_SOS_pointer_F", 25, 2, 4, ["30Rnd_65x39_caseless_mag", "30Rnd_65x39_caseless_mag_Tracer"], 6];
...
a3e_arr_AmmoDepotSpecialWeapons pushback ["arifle_MX_SW_F", 50, 2, 4, ["100Rnd_65x39_caseless_mag","100Rnd_65x39_caseless_mag_Tracer"], 6];
...
if(Param_UseDLCApex==1) then {
    ...
    a3e_arr_AmmoDepotSpecialWeapons pushback ["arifle_SPAR_01_snd_F", 50, 2, 4, ["30Rnd_556x45_Stanag_Sand", "30Rnd_556x45_Stanag_Sand_green", "30Rnd_556x45_Stanag_Sand_red", "30Rnd_556x45_Stanag_Sand_Tracer_Red", "30Rnd_556x45_Stanag_Sand_Tracer_Green", "30Rnd_556x45_Stanag_Sand_Tracer_Yellow"], 6];
    ...
    a3e_arr_AmmoDepotSpecialWeapons pushback ["arifle_SPAR_01_GL_snd_F", 50, 2, 4, ["30Rnd_556x45_Stanag_Sand", "30Rnd_556x45_Stanag_Sand_green", "30Rnd_556x45_Stanag_Sand_red", "30Rnd_556x45_Stanag_Sand_Tracer_Red", "30Rnd_556x45_Stanag_Sand_Tracer_Green", "30Rnd_556x45_Stanag_Sand_Tracer_Yellow", "1Rnd_HE_Grenade_shell", "1Rnd_Smoke_Grenade_shell", "UGL_FlareWhite_F"], 6];
	...
	a3e_arr_AmmoDepotSpecialWeapons pushback ["arifle_SPAR_02_snd_F", 50, 2, 4, ["150Rnd_556x45_Drum_Sand_Mag_F", "150Rnd_556x45_Drum_Sand_Mag_Tracer_F"], 3];
    a3e_arr_AmmoDepotSpecialWeapons pushback ["arifle_SPAR_03_blk_MOS_Pointer_Bipod_F", 25, 2, 4, ["20Rnd_762x51_Mag"], 8];
	a3e_arr_AmmoDepotSpecialWeapons pushback ["arifle_SPAR_03_snd_F", 25, 2, 4, ["20Rnd_762x51_Mag"], 8];
	};
if(Param_UseDLCMarksmen==1) then {
	a3e_arr_AmmoDepotSpecialWeapons pushback ["MMG_02_sand_F", 10, 1, 2, ["130Rnd_338_Mag"], 3];
	a3e_arr_AmmoDepotSpecialWeapons pushback ["MMG_02_camo_F", 10, 1, 2, ["130Rnd_338_Mag"], 3];
	a3e_arr_AmmoDepotSpecialWeapons pushback ["MMG_02_black_F", 10, 1, 2, ["130Rnd_338_Mag"], 3];
	a3e_arr_AmmoDepotSpecialWeapons pushback ["srifle_DMR_02_camo_AMS_LP_F", 20, 2, 4, ["10Rnd_338_Mag"], 10];
	a3e_arr_AmmoDepotSpecialWeapons pushback ["srifle_DMR_02_sniper_AMS_LP_S_F", 20, 2, 4, ["10Rnd_338_Mag"], 10];
	a3e_arr_AmmoDepotSpecialWeapons pushback ["srifle_DMR_03_AMS_F", 20, 2, 4, ["20Rnd_762x51_Mag"], 7];
	a3e_arr_AmmoDepotSpecialWeapons pushback ["srifle_DMR_03_multicam_F", 20, 2, 4, ["20Rnd_762x51_Mag"], 7];
	a3e_arr_AmmoDepotSpecialWeapons pushback ["srifle_DMR_03_tan_AMS_LP_F", 20, 2, 4, ["20Rnd_762x51_Mag"], 7];
    };
// non-CAST weapons
...
a3e_arr_AmmoDepotLaunchers pushback ["launch_B_Titan_short_F", 25, 1, 1, ["Titan_AP", "Titan_AT"], 3];
a3e_arr_AmmoDepotLaunchers pushback ["launch_MRAWS_sand_F", 25, 1, 2, ["MRAWS_HEAT_F", "MRAWS_HE_F"], 2];
a3e_arr_AmmoDepotLaunchers pushback ["launch_MRAWS_olive_F", 25, 1, 2, ["MRAWS_HEAT_F", "MRAWS_HE_F"], 2];
// non-CSAT weapons
a3e_arr_AmmoDepotLaunchers pushback ["launch_NLAW_F", 50, 3, 5, ["NLAW_F"], 2];
a3e_arr_AmmoDepotLaunchers pushback ["launch_MRAWS_olive_rail_F", 25, 1, 2, ["MRAWS_HEAT_F", "MRAWS_HE_F"], 2];
a3e_arr_AmmoDepotLaunchers pushback ["launch_MRAWS_sand_rail_F", 25, 1, 2, ["MRAWS_HEAT_F", "MRAWS_HE_F"], 2];
a3e_arr_AmmoDepotLaunchers pushback ["launch_I_Titan_F", 25, 1, 1, ["Titan_AA"], 3];
a3e_arr_AmmoDepotLaunchers pushback ["launch_I_Titan_short_F", 25, 1, 1, ["Titan_AP", "Titan_AT"], 3];
...
a3e_arr_AmmoDepotVehicleBackpacks = ["B_Carryall_mcamo"];
...
a3e_arr_AmmoDepotItems pushback ["muzzle_snds_m_snd_F", 10, 1, 3];  //5.56mm generic
a3e_arr_AmmoDepotItems pushback ["muzzle_snds_h", 10, 1, 3];  //6.5mm Katiba and MX
a3e_arr_AmmoDepotItems pushback ["muzzle_snds_h_snd_F", 10, 1, 3];  //6.5mm Katiba and MX
a3e_arr_AmmoDepotItems pushback ["muzzle_snds_H_MG_F", 10, 1, 3];  //6.5mm MX SW
a3e_arr_AmmoDepotItems pushback ["muzzle_snds_H_MG_blk_F", 10, 1, 3];  //6.5mm MX SW
a3e_arr_AmmoDepotItems pushback ["muzzle_snds_B", 10, 1, 3];  //7.62mm generic BLACK
a3e_arr_AmmoDepotItems pushback ["muzzle_snds_B_snd_F", 10, 1, 3];  //7.62mm generic 
if(Param_UseDLCMarksmen==1) then {
    a3e_arr_AmmoDepotItems pushback ["muzzle_snds_338_sand", 10, 1, 3];
...
a3e_arr_AmmoDepotItems pushback ["optic_Holosight_smg", 10, 1, 2];  //NATO and AAF
a3e_arr_AmmoDepotItems pushback ["optic_Holosight_smg_blk_F", 10, 1, 2];  //NATO
a3e_arr_AmmoDepotItems pushback ["optic_Aco", 10, 1, 2];  //NATO
a3e_arr_AmmoDepotItems pushback ["optic_ACO_grn", 20, 1, 3];  //CSAT AND AAF
a3e_arr_AmmoDepotItems pushback ["optic_Holosight", 10, 1, 2];  //NATO
...
if(Param_UseDLCMarksmen==1) then {
	...
	a3e_arr_AmmoDepotItems pushback ["optic_AMS_snd", 10, 1, 2];  //NATO (Marksmen DLC)	
	};
...
a3e_arr_CivilianCarWeapons pushback ["hgun_P07_F", "16Rnd_9x21_Mag", 5];
a3e_arr_CivilianCarWeapons pushback ["hgun_P07_snds_F", "30Rnd_9x21_Mag", 5];
...
a3e_arr_Scopes_Sniper = [
	...
	,"optic_LRPS"];
if(Param_UseDLCMarksmen==1) then {
	a3e_arr_Scopes_Sniper pushback "optic_AMS_snd";
...
a3e_arr_CrashSiteWeapons pushback ["srifle_GM6_camo_LRPS_F", 10, 1, 2, ["5Rnd_127x108_Mag", "5Rnd_127x108_APDS_Mag"], 9];
if(Param_UseDLCMarksmen==1) then {
...
if(Param_UseDLCApex==1) then {
	a3e_arr_CrashSiteWeapons pushback ["arifle_ARX_hex_DMS_Pointer_Snds_Bipod_F", 10, 2, 4, ["150Rnd_93x64_Mag"], 8];
};
...
a3e_arr_CrashSiteItems pushback ["muzzle_snds_B", 10, 1, 3];  //7.62mm generic BLACK
if(Param_UseDLCMarksmen==1) then {
	a3e_arr_CrashSiteItems pushback ["muzzle_snds_93mmg", 10, 1, 3];
    };
a3e_arr_CrashSiteItems pushback ["bipod_02_F_blk", 10, 1, 3];
a3e_arr_CrashSiteItems pushback ["bipod_02_F_hex", 10, 1, 3];
a3e_arr_CrashSiteItems pushback ["bipod_02_F_tan", 10, 1, 3];
