/*
 * SNOcription: This file contains the vehicle types and unit types for the units spawned in the mission, and the weapons and magazines found in ammo boxes/cars.
...
a3e_arr_Escape_InfantryTypes_Ind = [
	...
	,"OPTRE_UNSC_Army_Soldier_Marksman_SNO"
	,"OPTRE_UNSC_Army_Soldier_Marksman_SNO"
	,"OPTRE_UNSC_Army_Soldier_UAV_Op_SNO"
	,"OPTRE_UNSC_Army_Soldier_UAV_Op_SNO"
